...
>(
  (
    ...
    // Esto facilita el estilizado de la barra lateral con clases de Tailwind.
  ...
  (
    ...
    return (
      <div
        ...
        data-side={side}
      >
        {/* Esto es lo que maneja el espacio de la barra lateral en el escritorio */}
        <div
          className={cn(
        ...
        <div
          className={cn(
            ...
            // Ajustar el padding para las variantes flotante e inset.
            variant === "floating" || variant === "inset"
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        // Aumenta el área de impacto del botón en dispositivos móviles.
